            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.orders.form') }}" class="text-muted text-hover-primary">Orders</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Order Listing
...
{{--                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Customer</button>--}}
                            ...
                            <div class="d-flex justify-content-end align-items-center d-none" data-kt-customer-table-toolbar="selected">
                                ...
                                <button type="button" class="btn btn-info btn-sm mr-2" data-kt-customer-table-select="delete_selected">Detail</button>
                                <button type="button" class="btn btn-success btn-sm mr-2" data-kt-customer-table-select="delete_selected">Assign</button>
                            </div>
                            <!--end::Group actions-->
                        </div>
                        <!--end::Card toolbar-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Pickup Address</th>
                                <th class="min-w-125px">Dropoff Address</th>
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        <a href="" class="text-gray-800 text-hover-primary mb-1">{{ $order->id }}</a>
                                    </td>
                                    <td>
                                        <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ (isset($order->tasks->type)) ? $order->tasks->type : null }}</a>
                                    </td>
                                    <td>-</td>
                                    <td data-filter="mastercard">
                                        <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />{{ (isset($order->locations->address)) ? $order->locations->address : 'N/A' }}</td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Assign</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3">Map</a>
                                            </div>
                                            <div class="menu-item px-3">
